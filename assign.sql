...
select  salary from employee where salary >4000;
select * from employee where gender="female";
select * from employee where d_o_j >"2023-01-01";
select  * from employee where age>30;
select  * from employee where salary between 3000 and 4000;
select * from employee order by e_name desc;
 select *from employee order by e_id desc;
 alter table employee modify column gender varchar(10) default("other");
INSERT INTO employee (E_id, e_name, salary, age, D_O_J) VALUES
(1101, 'Jacob Jenkins', 3000, 20, '2023-09-26');
 select max(salary) from employee;
  select min(salary) from employee;
select count(salary) from employee where salary<4000 ;
select salary ,count(salary) from employee where salary<3000 group by salary;
select e_name from employee where e_name like'a%';
select e_name from employee where e_name like'%a';
select e_name from employee where e_name like'%or%';
select e_name from employee where e_name like'j%';
select e_name from employee where e_name like'%son';
select e_name from employee where e_name like'%ith%';
select * from employee where gender="male";
select * from employee where gender="female";
select avg(salary) from employee;
select avg(salary) from employee where gender="male";
select avg(salary) from employee where gender="female";
select *from employee where e_id=1001 or e_id=1005 or e_id=1010 ;
